    ...
    <body>
        ...
        <header class="header" id="header">
            <nav class="nav container">
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=0853-6107-5196&text=I want to booking" class="button nav__button">Booking Now</a>
            </nav>
        </header>
            ...
            <div class="footer__container container grid">
                <div>
                    ...
                    <p class="footer__description">
                        Kendaraan kami <br />
                        adalah kendaraan yang memiliki<br/>
